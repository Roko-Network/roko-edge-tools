...
node itself is distributed as a checksum-verified native bundle or offline
Docker image from
...
The guided Docker path uses the current release metadata and immutable local
image ID; it does not trust a moving registry tag.
